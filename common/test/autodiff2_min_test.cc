...
// TEST_F(CppADdTest, TieBreakingCheckMinBothNonEmpty) {
...
// TEST_F(CppADdTest, TieBreakingCheckMinOneNonEmpty) {

//   // Given `min(v1, v2)`, our overload returns whichever argument has
