...
class Simulator {
 public:
  ...
  /// Parameters for fine control of initialization.
  ...
  /// integrator in use.
  ///
  /// @param params (optional) a parameter structure (see above).
  ///
  ...
  SimulatorStatus Initialize(const InitializationParams& params = {});
